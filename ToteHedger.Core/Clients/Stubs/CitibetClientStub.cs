...
public sealed class CitibetClientStub : ICitibetClient
{
    ...
    public Task<BetResponse> PlaceBetAsync(BetRequest betRequest, CancellationToken cancellationToken)
    {
        ...
        return Task.FromResult(new BetResponse { Provider = "Citibet", BetId = Guid.NewGuid().ToString("N"), Status = "Accepted" });
    }
}
